                  ...
                  <table className="border table table-sm">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          A candidate has to re-submit manuscript (e.g. within 4
                          weeks for PhD student and 1 week for MS Student).
                        </td>
                        <td>
                          <input
                      ...
                      <tr>
                        <td>3</td>
                        <td>
                          The candidate is <b>not allowed</b> to resubmit the
                          same manuscript for reexamination
                        </td>
                        <td>
                          Candidate has to appear in next semester with
                          different idea.
                        </td>
                        <td>
                          <input
