          ...
          <div className="page-wrapper dashboardHeight">
            ...
            <div className="page-body">
              {/*               <div className="col-lg-12 mt-2">
                <div className="row">
                  <div className="col-md-2 col-sm-4">Registration Number :</div>
                  <select className="form-control form-control-sm  col-md-10 col-sm-8">
                    <option selected="selected" value={5916}>
                      SP21-PCS-005
                    </option>
                    ...
                    <option value={3574}>FA13-PCS-002</option>
                  </select>
                </div>
              </div> */}
              ...
              {/*               <div className="col-lg-12 mt-2">
                <div className="row">
                  <div className="col-md-2 col-sm-4">Student Name :</div>
                  <input
                    className="form-control form-control-sm  col-md-10 col-sm-8"
                    type="text"
                    min={0}
                    name="tutionFeePaid"
                    value="MOHAMMAD BILAL"
